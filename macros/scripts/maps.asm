...
MACRO chansey_event
	if _NARG == 2
		...
		object_event \1, \2, SPRITE_CHANSEY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumpstd, CHANSEY_POKECENTER_SCRIPT, \3
	endc
ENDM

MACRO chanseyheal_event
	if _NARG == 2
		object_event \1, \2, SPRITE_CHANSEY_OW, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumpstd, HEAL_CHANSEY_SCRIPT, -1
	else
		object_event \1, \2, SPRITE_CHANSEY_OW, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumpstd, HEAL_CHANSEY_SCRIPT, \3
	endc
ENDM

MACRO heal_event
	if _NARG == 3
		object_event \1, \2, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, \3, OBJECTTYPE_COMMAND, jumpstd, HEAL_POKECENTER_SCRIPT, -1
	else
		object_event \1, \2, SPRITE_NURSE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, \3, OBJECTTYPE_COMMAND, jumpstd, HEAL_POKECENTER_SCRIPT, \4
	endc
ENDM
