...
HTTPDownloadURL:
	db "gameboy.datacenter.ne.jmp/cgb/download"
.End

HTTPUploadURL:
	db "gameboy.datacenter.ne.jmp/cgb/upload"
.End

HTTPUtilityURL:
	db "gameboy.datacenter.ne.jmp/cgb/utility"
.End

HTTPRankingURL:
	db "gameboy.datacenter.ne.jmp/cgb/ranking"
.End
