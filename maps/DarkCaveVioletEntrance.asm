DarkCaveVioletEntrance_MapEvents:
	def_warp_events
	warp_event  3, 15, ROUTE_3, 3
	warp_event 17,  1, DARK_CAVE_BLACKTHORN_ENTRANCE, 2
	warp_event 35, 33, ROUTE_18, 3
	...
	rocksmash_event 16, 14
	rocksmash_event 27,  6
	rocksmash_event  7, 14
	rocksmash_event 36, 31
	...
	object_event 30, 28, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DarkCaveVioletEntranceRainShard, EVENT_DARK_CAVE_VIOLET_ENTRANCE_RAIN_SHARD
...
DarkCaveVioletEntranceRainShard:
	itemball SUN_SHARD
