...
MahoganyMart1F_MapEvents:
	...
	object_event  3,  6, SPRITE_DRAGON, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT,PAL_NPC_RED, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_DRAGONITE
