Route20_MapEvents:
	...
	bg_event  5, 87, BGEVENT_JUMPSTD, NO_BERRY_OR_FRUIT_SCRIPT
	bg_event  4, 88, BGEVENT_JUMPSTD, NO_BERRY_OR_FRUIT_SCRIPT
	bg_event  5, 88, BGEVENT_JUMPSTD, NO_BERRY_OR_FRUIT_SCRIPT
	...
	object_event  5, 87, SPRITE_BERRY, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_PURPLE, OBJECTTYPE_SCRIPT, 0, Route20BerryTree5, EVENT_ROUTE_20_BERRY_5
	object_event  4, 88, SPRITE_APRICORN, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route20ApricornTree1, EVENT_ROUTE_20_APRICORN_1
	object_event  5, 88, SPRITE_APRICORN, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, Route20ApricornTree2, EVENT_ROUTE_20_APRICORN_2
