BlackthornPokecenter1F_MapEvents:
	...
	def_object_events
	heal_event  3,  1, PAL_NPC_BLACK
	chansey_event  4,  1
	object_event  5,  3, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, BlackthornPokecenter1FGentlemanText, -1
	object_event  1,  4, SPRITE_TWIN, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_COMMAND, jumptextfaceplayer, BlackthornPokecenter1FTwinText, -1
