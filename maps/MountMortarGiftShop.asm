MountMortarGiftShop_MapEvents:
	...
	object_event  1,  6, SPRITE_LASS, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, MORN, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, MountMortarGiftShopLassText, -1
	object_event  5,  4, SPRITE_LASS, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, DAY, 0, OBJECTTYPE_COMMAND, jumptextfaceplayer, MountMortarGiftShopLassText, -1
