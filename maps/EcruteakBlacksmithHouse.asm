...
.ShinyBallScript
	...
	writetext TradeCrystalsForShinyBallText
	yesorno
...
.MyCraftingPeak
	writetext IveFoundMyPassionText
	waitbutton
	verbosegiveitem SHINY_BALL
	iffalse .NoRoom
...
EcruteakBlacksmithHouseShinyMonCodex:
	opentext
	writetext EcruteakBlacksmithHouseShinyMonCodexText
	yesorno
	iftrue .ReadBook
	closetext
	end
...
.Male
	writetext ShinyMaleMonText
	waitbutton
	sjump .GenderMenu

.Female
	writetext ShinyFemaleMonText
	waitbutton
	sjump .GenderMenu

.Genderless
	writetext ShinyGenderlessMonText
	waitbutton
	sjump .GenderMenu
...
EcruteakBlacksmithHouseShinyMonCodexText:
