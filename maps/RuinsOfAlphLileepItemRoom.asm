RuinsOfAlphLileepItemRoom_MapEvents:
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphLileepItemRoomGripClaw, EVENT_LILEEP_ITEM_ROOM_GRIP_CLAW
	object_event  5,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphLileepItemRoomFocusSash, EVENT_LILEEP_ITEM_ROOM_FOCUS_SASH
	object_event  2,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphLileepItemRoomHeavyBoots, EVENT_LILEEP_ITEM_ROOM_HEAVY_BOOTS
	object_event  5,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphLileepItemRoomZoomLens, EVENT_LILEEP_ITEM_ROOM_ZOOM_LENS
