...
RocketBaseElectrodeScript:
	...
	setevent EVENT_ROUTE_15_GATE_ROCKETS
...
TeamRocketBaseB2F_MapEvents:
	...
	object_event  9, 13, SPRITE_DRAGON, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B2F_DRAGONITE
