...
.party_loop
	...
	ld bc, (MON_EVS - 1) - MON_MAXHP ; This also set B to non-zero.
	add hl, bc

	call CalcMonStats ; B needs to be != 0 for the Effort Values to be accounted. Doesn't clobber HL.
	...
	ld de, MON_MAXHP - (MON_EVS - 1) ; This also set B to non-zero.
