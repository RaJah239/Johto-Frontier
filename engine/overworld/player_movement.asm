...
; Closing a WaitButton with the B Button prevents from using it until released.
	ldh a, [hWaitForBButtonRelease]
	and a
	...
	xor a
	ldh [hWaitForBButtonRelease], a ; We release the B button lock. If can be activated next frame.
