; Pack.Jumptable and BattlePack.Jumptable indexes
	...
	const PACKSTATE_INITFRUITPOCKET    ;  9
	const PACKSTATE_FRUITPOCKETMENU    ; 10
	const PACKSTATE_INITBATTLEPOCKET   ; 11
	const PACKSTATE_BATTLEPOCKETMENU   ; 12
...
; entries correspond to PACKSTATE_* constants
	...
	dw .InitTMHMPocket     ;  7
	dw .TMHMPocketMenu     ;  8
	dw .InitFruitPocket    ;  9
	dw .FruitPocketMenu    ; 10
	dw .InitBattlePocket   ; 11
	dw .BattlePocketMenu   ; 12
...
.ItemsPocketMenu:
	...
	lb bc, PACKSTATE_INITBATTLEPOCKET, PACKSTATE_INITFRUITPOCKET ; left then right
...
.KeyItemsPocketMenu:
	...
	lb bc, PACKSTATE_INITFRUITPOCKET, PACKSTATE_INITBALLSPOCKET ; left then right
	call Pack_InterpretJoypad
	ret c
	call .ItemBallsKey_LoadSubmenu
	ret
...
.TMHMPocketMenu:
	farcall TMHMPocket
	lb bc, PACKSTATE_INITBALLSPOCKET, PACKSTATE_INITBATTLEPOCKET ; left then right
	call Pack_InterpretJoypad
	ret c
...
.BallsPocketMenu:
	...
	lb bc, PACKSTATE_INITKEYITEMSPOCKET, PACKSTATE_INITTMHMPOCKET ; left then right
	call Pack_InterpretJoypad
	ret c
	call .ItemBallsKey_LoadSubmenu
	ret	
...
.FruitPocketMenu:
	...
	lb bc, PACKSTATE_INITITEMSPOCKET, PACKSTATE_INITKEYITEMSPOCKET ; left then right
	call Pack_InterpretJoypad
	ret c
	call .ItemBallsKey_LoadSubmenu
	ret	
...
.BattlePocketMenu:
	...
	lb bc, PACKSTATE_INITTMHMPOCKET, PACKSTATE_INITITEMSPOCKET ; left then right
	call Pack_InterpretJoypad
	ret c
	call .ItemBallsKey_LoadSubmenu
	ret
...
PackGFXPointers:
	...
	dw PackGFX + (15 tiles) * 5 ; FRUIT_POCKET
	dw PackGFX + (15 tiles) * 2 ; BATTLE_POCKET
...
; FRUIT_POCKET
	...
	db $45, $46, $47, $48, $49 ; fruit text
	db $02, $05, $05, $05, $03 ; bottom border

; BATTLE_POCKET
	db $00, $04, $04, $04, $01 ; top border
	db $4a, $4b, $4c, $4d, $4e ; battle text
	db $02, $05, $05, $05, $03 ; bottom border
