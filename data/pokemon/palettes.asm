...
INCBIN "gfx/pokemon/katu/front.gbcpal", middle_colors
...
INCBIN "gfx/pokemon/sneasler/front.gbcpal", middle_colors
...
INCBIN "gfx/pokemon/gholdengo/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/gholdengo/shiny.pal"
