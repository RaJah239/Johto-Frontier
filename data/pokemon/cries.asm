...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_BULBASAUR,   128,  129 ; ROTOM TODO
	mon_cry CRY_BULBASAUR,    32,  256 ; VICTINI TODO
	mon_cry CRY_BULBASAUR,     0,  320 ; DURALUDON TODO
	...
	mon_cry CRY_CATERPIE,    128,  160 ; TORCHIC TODO
	mon_cry CRY_METAPOD,     204,  129 ; COMBUSKEN TODO
	mon_cry CRY_CATERPIE,    119,  192 ; BLAZIKEN TODO
	mon_cry CRY_WEEDLE,      238,  129 ; TURTWIG TODO
	mon_cry CRY_BLASTOISE,   255,  129 ; GROTLE TODO
	mon_cry CRY_BLASTOISE,    96,  256 ; TORTERRA TODO
	mon_cry CRY_PIDGEY,      223,  132 ; PIDGEY
	mon_cry CRY_PIDGEOTTO,    40,  320 ; PIDGEOTTO
	mon_cry CRY_PIDGEOTTO,    17,  383 ; PIDGEOT
	mon_cry CRY_RATTATA,       0,  256 ; BUNEARY TODO
	mon_cry CRY_RATTATA,      32,  383 ; LOPUNNY TODO
	mon_cry CRY_SPEAROW,       0,  256 ; SHROOMISH TODO
	mon_cry CRY_FEAROW,       64,  288 ; BRELOOM TODO
	mon_cry CRY_EKANS,        18,  192 ; SKORUPI TODO
	mon_cry CRY_EKANS,       224,  144 ; DRAPION TODO
	mon_cry CRY_BULBASAUR,   238,  129 ; PIKACHU
	mon_cry CRY_RAICHU,      238,  136 ; RAICHU
	mon_cry CRY_NIDORAN_M,    32,  192 ; DRILBUR TODO
	mon_cry CRY_NIDORAN_M,   255,  383 ; EXCADRILL TODO
	...
	mon_cry CRY_VULPIX,       79,  144 ; MAKUHITA TODO
	mon_cry CRY_VULPIX,      136,  224 ; HARIYAMA TODO
	mon_cry CRY_PIDGEY,      255,  181 ; BALTOY TODO
	mon_cry CRY_PIDGEY,      104,  224 ; CLAYDOL TODO
	...
	mon_cry CRY_CLEFFA,       97,  145 ; WYRDEER TODO
	mon_cry CRY_PARAS,        32,  352 ; LARVESTA TODO
	mon_cry CRY_PARAS,        66,  383 ; LILEEP TODO
	mon_cry CRY_VENONAT,      68,  192 ; JOLTIK TODO
	mon_cry CRY_VENONAT,      41,  256 ; GALVANTULA TODO
	mon_cry CRY_DIGLETT,     170,  129 ; AXEW TODO
	mon_cry CRY_DIGLETT,      42,  144 ; FRAXURE TODO
	mon_cry CRY_CLEFAIRY,    119,  144 ; MEOWTH
	mon_cry CRY_CLEFAIRY,    153,  383 ; PERSIAN
	mon_cry CRY_PSYDUCK,      32,  224 ; SWABLU TODO
	mon_cry CRY_PSYDUCK,     255,  192 ; ALTARIA TODO
	...
	mon_cry CRY_PIDGEY,      255,  383 ; GIBLE TODO
	mon_cry CRY_PIDGEY,      119,  224 ; GABITE TODO
	mon_cry CRY_PIDGEY,        0,  383 ; GARCHOMP TODO
	mon_cry CRY_METAPOD,     192,  129 ; ROWLET TODO
	mon_cry CRY_METAPOD,     168,  320 ; DARTRIX TODO
	mon_cry CRY_METAPOD,     152,  383 ; DECIDUEYE TODO
	mon_cry CRY_GROWLITHE,   238,  129 ; VENIPEDE TODO
	mon_cry CRY_GROWLITHE,    72,  224 ; WHIRLIPEDE TODO
	mon_cry CRY_GROWLITHE,     8,  320 ; SCOLIPEDE TODO
	...
	mon_cry CRY_VULPIX,      240,  144 ; SNORUNT TODO
	mon_cry CRY_VULPIX,        0,  256 ; GLALIE TODO
	mon_cry CRY_GOLEM,       224,  192 ; FROSLASS TODO
	...
	mon_cry CRY_SPEAROW,     221,  129 ; TROPIUS
	...
	mon_cry CRY_FEAROW,        0,  256 ; RIOLU TODO
	mon_cry CRY_FEAROW,      111,  352 ; LUCARIO TODO
	...
	mon_cry CRY_KRABBY,       32,  352 ; BRONZOR TODO
	mon_cry CRY_KRABBY,      238,  352 ; BRONZONG TODO
	mon_cry CRY_VOLTORB,     237,  256 ; VOLTORB
	mon_cry CRY_VOLTORB,     168,  272 ; ELECTRODE
	mon_cry CRY_DIGLETT,       0,  256 ; WIMPOD TODO
	mon_cry CRY_DROWZEE,       0,  256 ; GOLISOPOD TODO
	mon_cry CRY_CLEFAIRY,      0,  256 ; LITWICK TODO
	mon_cry CRY_ODDISH,       79,  224 ; LAMPENT TODO
	mon_cry CRY_GOLEM,       128,  320 ; RALTS TODO
	mon_cry CRY_SEEL,        238,  320 ; KIRLIA TODO
	mon_cry CRY_SEEL,          0,  256 ; YANMEGA TODO
	mon_cry CRY_GOLEM,       230,  349 ; KOFFING
	mon_cry CRY_GOLEM,       255,  383 ; WEEZING
	mon_cry CRY_CHARMANDER,    0,  256 ; MAGNEZONE TODO
	mon_cry CRY_RHYDON,        0,  256 ; URSALUNA TODO
	mon_cry CRY_PIDGEOTTO,    10,  320 ; CHANSEY
	mon_cry CRY_GOLEM,         0,  256 ; TANGELA
	mon_cry CRY_KANGASKHAN,    0,  256 ; GLISCOR TODO
	mon_cry CRY_CLEFAIRY,    153,  144 ; HORSEA
	mon_cry CRY_CLEFAIRY,     60,  129 ; SEADRA
	mon_cry CRY_CATERPIE,    128,  192 ; VOLCARONA TODO
	mon_cry CRY_MARILL,      104,  256 ; SMOOCHUM
	mon_cry CRY_PARAS,         2,  160 ; STARYU
	mon_cry CRY_PARAS,         0,  256 ; STARMIE
	mon_cry CRY_KRABBY,        8,  192 ; MISMAGIUS TODO
	mon_cry CRY_CATERPIE,      0,  256 ; SCYTHER
	mon_cry CRY_DROWZEE,     255,  383 ; JYNX
	mon_cry CRY_VOLTORB,     143,  383 ; ELECTABUZZ
	mon_cry CRY_CHARMANDER,  255,  176 ; KATU TODO
	mon_cry CRY_PIDGEOTTO,     0,  256 ; ANNIHILAPE TODO
	...
	mon_cry CRY_VENONAT,     170,  383 ; KLEAVOR TODO
	mon_cry CRY_VENONAT,      61,  256 ; TANGROWTH TODO
	mon_cry CRY_VENONAT,      16,  160 ; MAMOSWINE TODO
	mon_cry CRY_WEEPINBELL,  170,  383 ; PORYGON
	mon_cry CRY_GROWLITHE,   240,  129 ; WEAVILE TODO
	mon_cry CRY_GROWLITHE,   255,  192 ; OMASTAR
	mon_cry CRY_CATERPIE,    187,  192 ; SNEASLER TODO
	mon_cry CRY_FEAROW,      238,  129 ; DARKRAI TODO
	...
	mon_cry CRY_BULBASAUR,    96,  192 ; BAGON TODO
	mon_cry CRY_BULBASAUR,    64,  256 ; SHELGON TODO
	mon_cry CRY_BULBASAUR,    60,  320 ; SALAMENCE TODO
	...
	mon_cry CRY_SENTRET,     138,  184 ; WURMPLE TODO
	mon_cry CRY_SENTRET,     107,  258 ; SILCOON TODO
	mon_cry CRY_HOOTHOOT,    145,  216 ; HOOTHOOT
	mon_cry CRY_HOOTHOOT,      0,  416 ; NOCTOWL
	mon_cry CRY_LEDYBA,        0,  222 ; BEAUTIFLY TODO
	mon_cry CRY_LEDYBA,     -150,  312 ; DUSTOX TODO
	...
	mon_cry CRY_PICHU,         0,  320 ; REGIROCK TODO
	mon_cry CRY_CLEFFA,       97,  145 ; REGICE TODO
	mon_cry CRY_CHIKORITA,   232,  232 ; REGISTEEL TODO
	...
	mon_cry CRY_CLEFFA,      132,  336 ; CASCOON TODO
	mon_cry CRY_MARILL,      283,  288 ; MARILL
	mon_cry CRY_MARILL,      182,  384 ; AZUMARILL
	mon_cry CRY_CLEFFA,     3904,  384 ; SUDOWOODO
	mon_cry CRY_CLEFFA,     -675,  456 ; CRADILY TODO
	mon_cry CRY_CLEFFA,       59,  200 ; SNOVER TODO
	mon_cry CRY_CLEFFA,       39,  312 ; ABOMASNOW TODO
	mon_cry CRY_CLEFFA,        0,  384 ; SOLROCK TODO
	mon_cry CRY_AIPOM,       -81,  232 ; LUNATONE TODO
	...
	mon_cry CRY_AIPOM,       162,  320 ; PORYGONZ TODO
	mon_cry CRY_VENONAT,    -233,  240 ; UMBREON
	mon_cry CRY_RHYDON,        0,  256 ; RHYDON
	mon_cry CRY_SLOWKING,    260,  512 ; TOGEKISS TODO
	mon_cry CRY_HOOTHOOT,    304,  232 ; MISDREAVUS
	mon_cry CRY_HOOTHOOT,    354,  256 ; UNOWN
	mon_cry CRY_AMPHAROS,    635,  324 ; SYLVEON TODO
	mon_cry CRY_GIRAFARIG,    65,  512 ; CHANDELURE TODO
	mon_cry CRY_SLOWKING,    128,  256 ; FERROTHORN TODO
	mon_cry CRY_SLOWKING,      0,  384 ; FERROSEED TODO
	mon_cry CRY_DUNSPARCE,   452,  256 ; HAXORUS TODO
	...
	mon_cry CRY_SLUGMA,     -472,  320 ; FEEBAS TODO
	mon_cry CRY_MAGCARGO,   -525,  448 ; MILOTIC TODO
	...
	mon_cry CRY_AIPOM,        44,  264 ; GALLADE TODO
	mon_cry CRY_SLUGMA,        0,  256 ; GARDEVOIR TODO
	mon_cry CRY_MARILL,      104,  256 ; ABSOL TODO
	mon_cry CRY_SUNFLORA,   -728,  180 ; REGIGIGAS TODO
	mon_cry CRY_TEDDIURSA,   374,   58 ; NOWN TODO
	...
	mon_cry CRY_ODDISH,     $1a0, $161 ; Gholdengo
