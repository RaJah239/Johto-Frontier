...
MapScenes::
	...
	scene_var ROUTE_19,                                    wRoute19SceneID
	...
	scene_var ROUTE_15_GATE,                               wRoute15GateSceneID
	...
	scene_var RUINS_OF_ALPH_LILEEP_CHAMBER,                wRuinsOfAlphLileepChamberSceneID
