InitialEvents:
	...
	dw EVENT_MT_MORTAR_SQUARE_CLEFAIRY
	...
	dw EVENT_VIOLET_GYM_THREE_RARE_CANDIES
	dw EVENT_AZALEA_GYM_SIX_NUGGETS
	dw EVENT_GOLDENROD_GYM_FIVE_HP_UPS
	dw EVENT_ECRUTEAK_GYM_FIVE_CALCIUMS
	dw EVENT_OLIVINE_GYM_FIVE_IRONS
	dw EVENT_CIANWOOD_GYM_FIVE_PROTEINS
	dw EVENT_MAHOGANY_GYM_FIVE_ZINCS
	dw EVENT_BLACKTHORN_GYM_7_RARE_CANDIES

; Debug Events
if DEF(_DEBUG)
	dw EVENT_CAUGHT_ALL_UNOWN
	dw EVENT_UNLOCK_STAT_SCREEN_EFFORT_VALUES
endc
