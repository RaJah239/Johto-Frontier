...
; ANIM_OBJ_BLUE_FLAME
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_BURNED, BATTLE_ANIM_FUNC_MOVE_IN_CIRCLE, PAL_BATTLE_OB_BLUE, $03 ; ANIM_OBJ_BLUE_FLAME

	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_SPARKLE, BATTLE_ANIM_FUNC_HIDDEN_POWER, PAL_BATTLE_OB_YELLOW, $11 ; ANIM_OBJ_DAZZLE
