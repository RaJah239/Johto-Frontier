...
; BATTLE_ANIM_OBJ_GRAY_GLOW
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_SMALL_GLOW, BATTLE_ANIM_FUNC_NULL, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_GLOW
; BATTLE_ANIM_OBJ_FLASH_CANNON
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_DRAGON_PULSE, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_GRAY, BATTLE_ANIM_GFX_CHARGE
; BATTLE_ANIM_OBJ_ICE_SPEAR
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLE_ANIM_FRAMESET_HORN, BATTLE_ANIM_FUNC_HORN, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_HORN
...
; ANIM_OBJ_HYDRO_PUMP
	battleanimobj RELATIVE_X, $b4, BATTLE_ANIM_FRAMESET_HYDRO_PUMP, BATTLE_ANIM_FRAMESET_HIT_BIG, PAL_BATTLE_OB_RED, BATTLE_ANIM_GFX_WATER 
