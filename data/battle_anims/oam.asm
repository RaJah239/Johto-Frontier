...
; entries correspond to BATTLE_ANIM_OAMSET_* constants
	...
	battleanimoam $0c,  9, .OAMData_cd ; BATTLE_ANIM_OAMSET_D9
	battleanimoam $12,  9, .OAMData_cd ; BATTLE_ANIM_OAMSET_DA
	battleanimoam $00, 16, .OAMData_e0 ; BATTLE_ANIM_OAMSET_DB
	battleanimoam $08, 16, .OAMData_e0 ; BATTLE_ANIM_OAMSET_DC
	battleanimoam $10, 16, .OAMData_e0 ; BATTLE_ANIM_OAMSET_DD
	battleanimoam $18, 16, .OAMData_e0 ; BATTLE_ANIM_OAMSET_DE
