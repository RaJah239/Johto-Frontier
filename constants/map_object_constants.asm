...
; rearrange engine\events\std_scripts.asm as needed
	...
	const MAGAZINE_BOOKSHELF_SCRIPT
	const RADIO1SCRIPT
	const RADIO2SCRIPT
	const NO_BERRY_OR_FRUIT_SCRIPT
	const POKECENTER_SIGN_SCRIPT
	const MART_SIGN_SCRIPT
	const ROCK_SMASH_SCRIPT
	const CHANSEY_POKECENTER_SCRIPT
	const HEAL_POKECENTER_SCRIPT
	const HEAL_CHANSEY_SCRIPT
	const VARIABLE_MART_SCRIPT
	const PORYGON_PC_SCRIPT
	const STRENGTH_SCRIPT
	const ELEVATOR_BUTTON_SCRIPT
	const TRASH_CAN_SCRIPT
