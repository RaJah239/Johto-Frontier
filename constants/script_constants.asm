...
; _GetVarAction.VarActionTable indexes (see engine/overworld/variables.asm)
	...
	const VAR_BATTLE_HALL_NORMAL_PONITS
	const VAR_BATTLE_HALL_INVERSE_PONITS
	const VAR_BATTLE_HALL_TYPELESS_PONITS
	const VAR_BATTLE_HALL_HARD_MODE_NORMAL_PONITS
	const VAR_BATTLE_HALL_HARD_MODE_INVERSE_PONITS
	const VAR_BATTLE_HALL_HARD_MODE_TYPELESS_PONITS
; battle tower points
