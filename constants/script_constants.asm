...
; _GetVarAction.VarActionTable indexes (see engine/overworld/variables.asm)
	...
	const VAR_BATTLE_POCKET    ; 1d
	const VAR_BATTLE_LOBBY_NORMAL_PONITS
	const VAR_BATTLE_LOBBY_INVERSE_PONITS
	const VAR_BATTLE_LOBBY_TYPELESS_PONITS
	const VAR_BATTLE_LOBBY_HARD_MODE_NORMAL_PONITS
	const VAR_BATTLE_LOBBY_HARD_MODE_INVERSE_PONITS
	const VAR_BATTLE_LOBBY_HARD_MODE_TYPELESS_PONITS
; battle tower points
	const VAR_BATTLE_TOWER_NORMAL_PONITS
	const VAR_BATTLE_TOWER_INVERSE_PONITS
	const VAR_BATTLE_TOWER_TYPELESS_PONITS
	const VAR_BATTLE_TOWER_HARD_MODE_NORMAL_PONITS
	const VAR_BATTLE_TOWER_HARD_MODE_INVERSE_PONITS
	const VAR_BATTLE_TOWER_HARD_MODE_TYPELESS_PONITS
; battle tower mirror mode points
	const VAR_BATTLE_TOWER_MIRROR_NORMAL_PONITS
	const VAR_BATTLE_TOWER_MIRROR_INVERSE_PONITS
	const VAR_BATTLE_TOWER_MIRROR_TYPELESS_PONITS
	const VAR_BATTLE_TOWER_MIRROR_HARD_MODE_NORMAL_PONITS
	const VAR_BATTLE_TOWER_MIRROR_HARD_MODE_INVERSE_PONITS
	const VAR_BATTLE_TOWER_MIRROR_HARD_MODE_TYPELESS_PONITS
