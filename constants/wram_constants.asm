...
; wPokegearFlags::
	...
	const ENGINE_START_MENU_WARP_F
...
; wDailyFlags1::
	...
	const DAILYFLAGS1_ENGINE_MET_OTIS_TODAY_F             ; 7

; wDailyFlags1 9-16
	const DAILYFLAGS1_CIANWOOD_PHOTOGRAPH
	const DAILYFLAGS1_ENGINE_DAILY_MYSTERY_GIFT
...
; wSwarmFlags::
	...
	const SWARMFLAGS_MOBILE_4_F                  ; 4 ; unused
