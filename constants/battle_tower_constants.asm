...
DEF BATTLETOWER_STREAK_LENGTH EQU 3

DEF BATTLETOWER_NUM_UNIQUE_MON EQU 40
DEF BATTLETOWER_NUM_UNIQUE_TRAINERS EQU 70

DEF BATTLETOWER_TRAINERDATALENGTH EQU 18 * 2 ; $24
DEF BATTLE_TOWER_STRUCT_LENGTH EQU NAME_LENGTH + 6 * NICKNAMED_MON_STRUCT_LENGTH + BATTLETOWER_TRAINERDATALENGTH ; $e0
...
; BattleTowerAction setval arguments (see engine/events/battle_tower/battle_tower.asm)
	...
	const BATTLETOWERACTION_05 ; to go
	const BATTLETOWERACTION_06 ; reset stuff in SRAM bank 5 ; to go
	...
	const BATTLETOWERACTION_0C ; more time stuff in SRAM bank 5 ; to go
	const BATTLETOWERACTION_0D ; more time stuff in SRAM bank 5 ; to go
	const BATTLETOWERACTION_EGGTICKET
	const BATTLETOWERACTION_0F ; check w3_d090
	const BATTLETOWERACTION_10 ; dw based on s5_a800 ; to go
	const BATTLETOWERACTION_11 ; store 0 in s5_aa8d ; to go
	const BATTLETOWERACTION_12 ; store 1 in s5_aa8d ; to go
	const BATTLETOWERACTION_13 ; check s5_aa8d ; to go
	...
	const BATTLETOWERACTION_16 ; update time in SRAM bank 5 ; to go
	const BATTLETOWERACTION_17 ; check time in SRAM bank 5 ; to go
