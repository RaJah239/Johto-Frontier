; MoveEffectsPointers indexes (see data/moves/effects_pointers.asm)
	...
	const EFFECT_OHKO ; unused right now
	...
	const EFFECT_BARRIER
	const EFFECT_VENOSHOCK
	const EFFECT_FURY_DRIVE
	const EFFECT_TRICK_ROOM
	const EFFECT_TAUNT
	const EFFECT_RECOIL_PARA_HIT
	const EFFECT_ATK_DEF_UP_HIT
	const EFFECT_BRICK_BREAK
	const EFFECT_ACROBATICS
	const EFFECT_RECOIL_DEF_DN_HIT
