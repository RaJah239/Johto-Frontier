...
; Johto Frontier events
	...
	const EVENT_ROUTE_33_BERRY_1       ; PSNCUREBERRY
	const EVENT_ROUTE_33_BERRY_2       ; MINT_BERRY
	const EVENT_ROUTE_33_APRICORN_1    ; RED_APRICORN
	const EVENT_ROUTE_33_APRICORN_2    ; BLU_APRICORN
	const EVENT_ROUTE_33_APRICORN_3    ; GRN_APRICORN
