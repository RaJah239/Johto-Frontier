...
; Johto Frontier events
	...
	const EVENT_ROUTE_38_BERRY_1       ; BURNT_BERRY
	const EVENT_ROUTE_38_BERRY_2       ; MYSTERYBERRY
	const EVENT_ROUTE_39_BERRY_1       ; MINT_BERRY
	const EVENT_ROUTE_39_APRICORN_1    ; GRN_APRICORN
