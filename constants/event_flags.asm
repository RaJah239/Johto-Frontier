...
; HMs items (EVENT_GOT_GEYSER_BOOTS is with the Johto itemballs)
	const EVENT_GOT_LANTERN
	const EVENT_GOT_HM01_FLY
	const EVENT_GOT_AXE
	const EVENT_GOT_PADDLE_BOAT
	const EVENT_GOT_POWER_GLOVE
	const EVENT_GOT_STABILIZER
...
; Johto hidden items
	...
	const EVENT_SILVER_CAVE_OUTSIDE_FULL_RESTORE
