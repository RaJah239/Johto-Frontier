...
; Johto Frontier events
	...
	const EVENT_ROUTE_35_BERRY_1       ; MYSTERYBERRY
	const EVENT_ROUTE_35_APRICORN_1    ; BLU_APRICORN
	const EVENT_ROUTE_35_APRICORN_2    ; YLW_APRICORN
	const EVENT_ROUTE_35_APRICORN_3    ; RED_APRICORN
