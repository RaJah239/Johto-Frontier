...
; Johto Frontier events
	...
	const EVENT_ROUTE_26_BERRY_1       ; GOLD_BERRY
	const EVENT_ROUTE_26_BERRY_2       ; MIRACLEBERRY
	const EVENT_ROUTE_26_BERRY_3       ; GOLD_BERRY
	const EVENT_ROUTE_26_BERRY_4       ; MIRACLEBERRY
