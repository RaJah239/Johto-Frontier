...
; New to Crystal
	...
	const EVENT_KABUTO_ITEM_ROOM_GRIP_CLAW
	const EVENT_KABUTO_ITEM_ROOM_FOCUS_SASH
	const EVENT_KABUTO_ITEM_ROOM_HEAVY_BOOTS
	const EVENT_KABUTO_ITEM_ROOM_ZOOM_LENS
