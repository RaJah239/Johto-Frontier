...
DEF SPRITE_POKEMON EQU const_value
	...
	const SPRITE_RAIKOU_OW ; 84
	const SPRITE_ENTEI_OW ; 85
	const SPRITE_GENGAR ; 86
	const SPRITE_ZUBAT ; 87
	const SPRITE_MAGIKARP ; 88
	const SPRITE_SQUIRTLE ; 89
	const SPRITE_CHANSEY ; 8a
	const SPRITE_TANGELA ; 8c
...
DEF SPRITE_VARS EQU const_value
	...
	const SPRITE_DIRECTOR_IMPERSONATOR ; f4
	const SPRITE_LINK_TRAINER ; f5
